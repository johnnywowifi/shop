...
abstract class Category implements ActiveRecordInterface 
{
    ...
    public function setCategoryname($v)
    {
        ...
        if ($this->categoryname !== $v) {
            $this->categoryname = $v;
            $this->modifiedColumns[CategoryTableMap::COL_CATEGORYNAME] = true;
        }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CategoryTableMap::COL_CATEGORYNAME)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CategoryTableMap::COL_CATEGORYNAME)) {
            $criteria->add(CategoryTableMap::COL_CATEGORYNAME, $this->categoryname);
        }
        if ($this->isColumnModified(CategoryTableMap::COL_DESCRIPTION)) {
