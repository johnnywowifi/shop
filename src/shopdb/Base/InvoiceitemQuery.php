...
use \Invoiceitem as ChildInvoiceitem;
use \InvoiceitemQuery as ChildInvoiceitemQuery;
use \Exception;
use \PDO;
use Map\InvoiceitemTableMap;
...
/**
 * Base class that represents a query for the 'invoiceitem' table.
 *
 * 
 *
 * @method     ChildInvoiceitemQuery orderById($order = Criteria::ASC) Order by the id column
 *
 * @method     ChildInvoiceitemQuery groupById() Group by the id column
 *
 ...
 *
 * @method     ChildInvoiceitem findOneById(int $id) Return the first ChildInvoiceitem filtered by the id column *
 ...
 *
 * @method     ChildInvoiceitem requireOneById(int $id) Return the first ChildInvoiceitem filtered by the id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildInvoiceitem[]|ObjectCollection findById(int $id) Return ChildInvoiceitem objects filtered by the id column
...
abstract class InvoiceitemQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Base\InvoiceitemQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Invoiceitem', $modelAlias = null)
    {
    ...
    public function findPk($key, ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = InvoiceitemTableMap::getInstanceFromPool(null === $key || is_scalar($key) || is_callable([$key, '__toString']) ? (string) $key : $key))) && !$this->formatter) {
    ...
    {
        $sql = 'SELECT id FROM invoiceitem WHERE id = :p0';
        try {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(InvoiceitemTableMap::COL_ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(InvoiceitemTableMap::COL_ID, $keys, Criteria::IN);
    }
    ...
    public function filterById($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(InvoiceitemTableMap::COL_ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(InvoiceitemTableMap::COL_ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(InvoiceitemTableMap::COL_ID, $id, $comparison);
    }
    ...
    {
        if ($invoiceitem) {
            $this->addUsingAlias(InvoiceitemTableMap::COL_ID, $invoiceitem->getId(), Criteria::NOT_EQUAL);
        }
    ...
    /**
     * Deletes all rows from the invoiceitem table.
     *
