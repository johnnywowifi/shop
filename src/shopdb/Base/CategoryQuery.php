 ...
 * @method     ChildCategoryQuery orderByCategoryname($order = Criteria::ASC) Order by the categoryname column
 ...
 * @method     ChildCategoryQuery groupByCategoryname() Group by the categoryname column
 ...
 * @method     ChildCategory findOneByCategoryname(string $categoryname) Return the first ChildCategory filtered by the categoryname column
 ...
 * @method     ChildCategory requireOneByCategoryname(string $categoryname) Return the first ChildCategory filtered by the categoryname column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildCategory[]|ObjectCollection findByCategoryname(string $categoryname) Return ChildCategory objects filtered by the categoryname column
...
abstract class CategoryQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT id, categoryname, description FROM category WHERE id = :p0';
        try {
    ...
    public function filterByCategoryname($categoryname = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(CategoryTableMap::COL_CATEGORYNAME, $categoryname, $comparison);
    }
