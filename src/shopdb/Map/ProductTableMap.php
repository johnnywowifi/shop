...
class ProductTableMap extends TableMap
{
     ...
     */
    const COL_PRODUCTNAME = 'product.productname';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Productname', 'Description', 'Price', 'CategoryId', ),
        self::TYPE_CAMELNAME     => array('id', 'productname', 'description', 'price', 'categoryId', ),
        self::TYPE_COLNAME       => array(ProductTableMap::COL_ID, ProductTableMap::COL_PRODUCTNAME, ProductTableMap::COL_DESCRIPTION, ProductTableMap::COL_PRICE, ProductTableMap::COL_CATEGORY_ID, ),
        self::TYPE_FIELDNAME     => array('id', 'productname', 'description', 'price', 'category_id', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Productname' => 1, 'Description' => 2, 'Price' => 3, 'CategoryId' => 4, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'productname' => 1, 'description' => 2, 'price' => 3, 'categoryId' => 4, ),
        self::TYPE_COLNAME       => array(ProductTableMap::COL_ID => 0, ProductTableMap::COL_PRODUCTNAME => 1, ProductTableMap::COL_DESCRIPTION => 2, ProductTableMap::COL_PRICE => 3, ProductTableMap::COL_CATEGORY_ID => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'productname' => 1, 'description' => 2, 'price' => 3, 'category_id' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('productname', 'Productname', 'VARCHAR', true, 100, null);
