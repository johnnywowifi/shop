...
/**
 * This class defines the structure of the 'invoiceitem' table.
 *
 *
 *
...
class InvoiceitemTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.InvoiceitemTableMap';
     ...
     */
    const OM_CLASS = '\\Invoiceitem';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Invoiceitem';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(InvoiceitemTableMap::COL_ID, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(InvoiceitemTableMap::COL_ID => 0, ),
    ...
    {
        // attributes
        $this->setName('invoiceitem');
        $this->setPhpName('Invoiceitem');
        $this->setIdentifierQuoting(false);
        $this->setClassName('\\Invoiceitem');
        $this->setPackage('');
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(InvoiceitemTableMap::COL_ID);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Invoiceitem) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(InvoiceitemTableMap::DATABASE_NAME);
            $criteria->add(InvoiceitemTableMap::COL_ID, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(InvoiceitemTableMap::COL_ID) && $criteria->keyContainsValue(InvoiceitemTableMap::COL_ID) ) {
