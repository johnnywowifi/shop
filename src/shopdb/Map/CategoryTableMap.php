...
class CategoryTableMap extends TableMap
{
     ...
     */
    const COL_CATEGORYNAME = 'category.categoryname';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Categoryname', 'Description', ),
        self::TYPE_CAMELNAME     => array('id', 'categoryname', 'description', ),
        self::TYPE_COLNAME       => array(CategoryTableMap::COL_ID, CategoryTableMap::COL_CATEGORYNAME, CategoryTableMap::COL_DESCRIPTION, ),
        self::TYPE_FIELDNAME     => array('id', 'categoryname', 'description', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Categoryname' => 1, 'Description' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'categoryname' => 1, 'description' => 2, ),
        self::TYPE_COLNAME       => array(CategoryTableMap::COL_ID => 0, CategoryTableMap::COL_CATEGORYNAME => 1, CategoryTableMap::COL_DESCRIPTION => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'categoryname' => 1, 'description' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('categoryname', 'Categoryname', 'VARCHAR', true, 45, null);
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CategoryTableMap::COL_CATEGORYNAME);
